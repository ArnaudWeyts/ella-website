      ...
      <g id="Layer_1-2" data-name="Layer 1">
        <g id="person">
          <g>
            <path
              className="cls-2"
              d="M81.72,188.69c-5,13-3,27.47,4,39.42,4.61,7.8,11.23,15.53,19.33,15.53s15-8,19.77-15.87a45.44,45.44,0,0,0,5.41-32.49c-2.72-13.26-9.26-29.07-24.93-26.5C92.12,170.93,85.22,179.51,81.72,188.69Z"
            />
            <path
              className="cls-3"
              d="M79.8,212.51s-1.12-12.93,1.71-20a6.74,6.74,0,0,1,6.29-4.1h8.86a16.69,16.69,0,0,0,5.63-1l16.71-6A81.62,81.62,0,0,0,126.44,193c4.36,5.54,4.77,18,4.77,18s1-16.8,3.39-19.68l-3.39-9.84v-4.8L126.44,175l-2.4-4.08-6.48-7.2-.72,2.4s-14.88-10.32-30.47,1S79.8,212.51,79.8,212.51Z"
            />
            <path
              className="cls-2"
              d="M128.64,219.7l1.61-16.36s4.47-3.07,3.75,4.84S128.64,219.7,128.64,219.7Z"
            />
            <path
              className="cls-2"
            ...
            <polygon
              className="cls-4"
              points="100.24 201.17 100.24 198.65 86.85 198.65 84.67 202.43 87.5 201 100.24 201.17"
            />
            <path
              className="cls-1"
              d="M90.63,206.78s2.14-2.37,4.87-2.23a4.65,4.65,0,0,1,3.92,2.23,6,6,0,0,1-4.39,2A6.58,6.58,0,0,1,90.63,206.78Z"
            />
            <polygon
              className="cls-4"
              points="110.18 201.17 110.18 198.65 123.57 198.65 125.75 202.43 122.92 201 110.18 201.17"
            />
            <path
              className="cls-1"
          ...
          <path
            className="cls-7"
            d="M175.08,286a14.76,14.76,0,0,1-14.76,14.76H49.84A14.76,14.76,0,0,1,35.08,286v-6.78c0,8.15,6.61,17.46,14.76,17.46H160.32c8.15,0,14.76-9.31,14.76-17.46Z"
          />
          <g>
            <path
              className="cls-8"
              d="M83.29,316.37h43.33L121,266a10.89,10.89,0,0,0-10.82-9.67H99.78A10.89,10.89,0,0,0,89,266Z"
            />
            <path
              className="cls-9"
              d="M99.78,256.37A10.89,10.89,0,0,0,89,266l-5.66,50.33h2.36L91.32,266a10.89,10.89,0,0,1,10.82-9.67Z"
            />
          </g>
        </g>
        <g id="Ella-icon">
        ...
        <ellipse className="cls-1" cx="105.2" cy="338.68" rx="92.96" ry="5.66" />
        <image
          id="KF-icon"
          width="400"
          height="661"
